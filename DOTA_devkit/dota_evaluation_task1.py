...
def parse_args():
    ...
    parser.add_argument('--annopath', default='/mnt/2tra/datasets/dota/val/labelTxt/{:s}.txt', help='checkpoint file')
    parser.add_argument('--imagesetfile', default='/mnt/2tra/datasets/dota/val/imgnamefile.txt', help='checkpoint file')
