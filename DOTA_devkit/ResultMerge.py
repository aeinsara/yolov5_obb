...
if __name__ == '__main__':
    ...
    parser.add_argument('--scrpath', type=str, default='', help='scrpath')
    parser.add_argument('--dstpath', type=str, default='', help='dstpath')
    # parser.add_argument('--task', type=str, default='train', help='task')
    opt = parser.parse_args()
    print(opt.scrpath,opt.dstpath)
    mergebypoly(opt.scrpath,opt.dstpath)
