...
def run(data,
    ...
    if not training:
        ...
        # print('cfg imgsz, batch_size, stride, names, single_cls,pad, pt, workers, ===== ', imgsz, batch_size, stride, names, single_cls,pad, pt, workers, colorstr(f'{task}: '))
    ...
    pcb = PrototypicalCalibrationBlock(data) #..................... sara added
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        dt[2] += time_sync() - t3
        # Metrics
        # print('len(out), im.shape', len(out), im.shape)
        for si, pred in enumerate(out): # pred (tensor): (n, [xylsθ, conf, cls])
            ...
            seen += 1
            pred = pcb.execute_calibration(paths[si], labels, pred, img[si]) #..................... sara added
            ...
            if save_txt: # just save hbb pred results!
                ...
                # save_one_txt(pred_hbbn_calibrated, save_conf, shape, file=save_dir / 'labels' / (path.stem + '.txt'))
            ...
            if save_json: # save hbb pred results and poly pred results.
                ...
                # save_one_json(pred_hbbn_calibrated, pred_polyn, jdict, path, class_map)
