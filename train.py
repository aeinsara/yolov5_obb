...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        # print('fewshot == ', opt.fewshot)
        if opt.fewshot == 'False' :#........... sara added
            # print('fewshot in if == ', opt.fewshot)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--fewshot', default='False', help='few-shot learning') # ....... sara added
